...
# Data Retreival
```{r}
meat <- read.csv("datathon_data/meat.csv", header=TRUE,
   sep=",")
...
for(cunch in selected.countries) {
   ...
   obesity.both.vals <- c(obesity.vals, obesity$obesity.both[obesity["Country"] == cunch])
   obesity.male.vals <- c(obesity.vals, obesity$obesity.male[obesity["Country"] == cunch])
   obesity.female.vals <- c(obesity.vals, obesity$obesity.female[obesity["Country"] == cunch])
